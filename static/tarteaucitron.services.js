...
tarteaucitron.services.googletagmanagerwithfallback = {
    ...
    "js": function () {
        "use strict";
        if (tarteaucitron.user.googletagmanagerwithfallbackId === undefined) {
            return;
        }
        window.dataLayer = window.dataLayer || [];
        window.dataLayer.push({
        ...
        tarteaucitron.addScript('//www.googletagmanager.com/gtm.js?id=' + tarteaucitron.user.googletagmanagerwithfallbackId);
    },
    "fallback": function () {
        window.dataLayer = window.dataLayer || [];
        window.dataLayer.push({
